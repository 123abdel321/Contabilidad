...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('fac_productos', function (Blueprint $table) {
            ...
            $table->integer('tipo_producto')->default(0)->comment('0:Producto, 1:Servicio, 2:Combo, 3:Parqueadero')->nullable();
            $table->integer('tipo_tiempo')->default(1)->comment('1:Hora, 2:Día, 3:Mes')->nullable();
            $table->integer('tipo_vehiculo')->default(1)->comment('1:Carro, 2:Moto, 3:Otros')->nullable();
            $table->integer('fraccion_hora')->default(0)->comment('0:No, 1:Si')->nullable();
