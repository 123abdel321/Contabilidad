...
return new class extends Migration
{
    ...
    {
        Schema::create('inf_documentos_generales_detalles', function (Blueprint $table) {
            $table->id();
            $table->integer('id_documentos_generales');
    ...
    {
        Schema::dropIfExists('inf_documentos_generales_detalles');
    }
};
