...
return new class extends Migration
{
    ...
    {
        Schema::connection('informes')->create('inf_impuestos_detalles', function (Blueprint $table) {  
            $table->id();
            $table->integer('id_impuestos');
            ...
            $table->decimal('valor_base', 15)->nullable();            
            $table->decimal('porcentaje_base', 15)->nullable();
