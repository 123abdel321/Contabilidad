...
class CarteraController extends Controller
{
    ...
    public function generate(Request $request)
    {
		...
		ksort($this->cuentasCobrarCollection, SORT_STRING | SORT_FLAG_CASE);
        
        return response()->json([
            'success'=>	true,
            'data' => array_values($this->cuentasCobrarCollection),
    ...
    private function newCuentaData($cuenta, $auxiliar, $cuentasAsociadas)
    {
        ...
        $this->cuentasCobrarCollection[$cuenta] = [
            'id_nit' => '',
            'numero_documento' => '',
            'nombre_nit' => '',
            'razon_social' => '',
    ...
    {
        $this->cuentasCobrarCollection[$cuenta]['saldo_anterior']+= number_format((float)$auxiliar->saldo_anterior, 2, '.', '');
        $this->cuentasCobrarCollection[$cuenta]['debito']+= number_format((float)$auxiliar->debito, 2, '.', '');
        $this->cuentasCobrarCollection[$cuenta]['credito']+= number_format((float)$auxiliar->credito, 2, '.', '');
        $this->cuentasCobrarCollection[$cuenta]['saldo_final']+= number_format((float)$auxiliar->saldo_final, 2, '.', '');
    }
    ...
    private function addTotalsData($auxiliares)
    {
        ...
        $this->cuentasCobrarCollection['9999'] = [
            'id_nit' => '',
            'numero_documento' => '',
            'nombre_nit' => '',
            'razon_social' => '',
    ...
    private function addDetilsData($auxiliaresDetalle)
    {
        foreach ($auxiliaresDetalle as $auxiliarDetalle) {
            ...
            $this->cuentasCobrarCollection[$cuentaNueva] = [
	...
	{
		return isset($this->cuentasCobrarCollection[$cuenta]);
	}
}
