...
Route::get('/login-direct', [LoginController::class, 'loginDirectoGet'])->name('login-direct');
Route::post('/login-direct', [LoginController::class, 'loginDirectoPost'])->name('login-direct');
