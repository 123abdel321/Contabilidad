<div class="row" style="padding: 4px;">
    ...
    <div id="div-valor_presupuesto" class="form-group col-12 col-sm-6 col-md-3" style="display: none;">
        <label for="example-text-input" class="form-control-label">Presupuesto</label>
        <input type="text" class="form-control form-control-sm text-align-right" name="valor_presupuesto" id="valor_presupuesto" data-type="currency" onfocus="this.select();">
    </div>

    <div id="div-buscar_presupuesto" class="form-group col-12 col-sm-6 col-md-3" style="display: none;">
    ...
    <div class="form-group col-12 col-sm-6 col-md-3" style="margin-bottom: unset !important;">
        ...
        <button type="button" class="btn btn-primary btn-sm" id="generarPresupuesto" style="display: none; margin-bottom: unset !important; margin-top: 15px;">Generar presupuesto</button>
    </div>
</div>
