    ...
    <div class="row">
        ...
        <div class="card mb-4">
            <div class="card-body" style="padding: 0 !important;">
                ...
                @include('pages.contabilidad.resultados.resultados-filter')

            </div>
        </div>
        
        <!-- <div class="card cardTotalResultado" style="content-visibility: auto; overflow: auto; border-radius: 20px 20px 0px 0px;">
