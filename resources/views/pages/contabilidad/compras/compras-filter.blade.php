                ...
                <form id="comprasFilterForm" class="needs-validation" style="margin-top: 10px;" novalidate>
                    <div class="row">
                        ...
                        <div class="form-group col-6 col-sm-4 col-md-4">
                            ...
                            <input name="fecha_manual_compras" id="fecha_manual_compras" class="form-control form-control-sm" type="date">
                        </div>
                        ...
                        <!-- <div class="form-group col-12 col-sm-3 col-md-2 row" style="margin-bottom: 0.1rem !important;">
                            <label for="example-text-input" class="form-control-label">Compras</label>
                            <div class="form-check col-12 col-md-12 col-sm-12" style="min-height: 0px; margin-bottom: 0px; margin-top: -2px; margin-left: 5px;">
                                <input class="form-check-input" type="radio" name="nivel_compras" id="nivel_compras1" style="font-size: 11px;" checked>
                                <label class="form-check-label" for="nivel_compras1" style="font-size: 11px;">
                                    Todos
                                </label>
                            </div>
                            <div class="form-check col-12 col-md-12 col-sm-12" style="min-height: 0px; margin-bottom: 0px; margin-top: -2px; margin-left: 5px;">
                                <input class="form-check-input" type="radio" name="nivel_compras" id="nivel_compras2" style="font-size: 11px;">
                                <label class="form-check-label" for="nivel_compras2" style="font-size: 11px;">
                                    Anulados
                                </label>
                            </div>
                        </div> -->
