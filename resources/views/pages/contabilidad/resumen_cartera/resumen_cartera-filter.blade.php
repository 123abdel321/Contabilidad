                    ...
                    <div class="row">
                        ...
                        @if ($ubicacion_maximoph)
                            ...
                            <div class="form-group col-2 col-sm-2 col-md-3 row" style="margin-bottom: 0.1rem !important;">
                                ...
                                <div class="form-check col-12 col-md-12 col-sm-12" style="min-height: 0px; margin-bottom: 0px; margin-top: -2px; margin-left: 5px;">
                                    <input class="form-check-input" type="radio" name="proveedores_resumen_cartera" id="proveedores_resumen_cartera1" style="font-size: 11px;">
                                    <label class="form-check-label" for="proveedores_resumen_cartera1" style="font-size: 11px;">
                                        Si
                                    </label>
                                </div>
                            </div>
