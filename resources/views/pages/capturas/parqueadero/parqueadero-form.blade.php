    ...
    <div class="modal-dialog modal-dialog-centered modal-lg modal-fullscreen-md-down modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="textParqueaderoCreate" style="display: none;">Agregar parqueadero</h5>
                <h5 class="modal-title" id="textParqueaderoUpdate" style="display: none;">Editar parqueadero</h5>
