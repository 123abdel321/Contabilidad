<div class="modal fade" id="cesantiasInteresesConfirmModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-fullscreen-md-down modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" >Agregar cesantías e intereses</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                </button>
            </div>
            <div class="modal-body">
                <form id="cesantiasInteresesConfirm" style="margin-top: 10px;">
                    <div class="row">

                        <h6 class="section-title bg-light p-2 mb-3">1. Seleccione el periodo donde desea grabar la novedad de intereses:</h6>

                        <div class="form-group col-12">
                            <label for="fecha_novedad_cesantias_intereses" class="form-control-label">Fecha novedad</label>
                            <input type="date" class="form-control form-control-sm" name="fecha_novedad_cesantias_intereses" id="fecha_novedad_cesantias_intereses" required disabled>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button id="saveCesantiasIntereses" type="button" class="btn bg-gradient-success btn-sm" >Guardar</button>
                <button id="saveCesantiasInteresesLoading" class="btn btn-success btn-sm ms-auto" style="display:none; float: left;" disabled>
                    Cargando
