<div class="row" style="padding: 4px;">
    ...
    <div class="col-6 col-sm-6 col-md-8" style="margin-top: 20px;">
        ...
        <span id="guardarCesantiasInteresesDisabled" class="badge bg-gradient-dark" style="min-width: 40px; margin-right: 3px; color: #adadad; float: inline-end; margin-left: 7px; margin-bottom: 0px !important;">
        ...
        <span class="badge bg-gradient-info btn-bg-gold-loading" id="cargarCesantiasInteresesLoading" style="display:none; min-width: 40px; float: inline-end; margin-bottom: 0px !important;" disabled>
            <i class="fas fa-spinner fa-spin" style="font-size: 17px;"></i>
            <b style="vertical-align: text-top;">&nbsp;CARGAR</b>
        </span>
