            ...
            <div class="accordion-body text-sm" style="padding: 0 !important;">
                ...
                <form id="pagoFilterForm" class="needs-validation row" style="margin-top: 10px;" novalidate>
                    ...
                    <div class="form-group col-12 col-sm-6 col-md-2">
                        ...
                        <input name="fecha_manual_pago" id="fecha_manual_pago" class="form-control form-control-sm" type="date" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-12 col-sm-6 col-md-2">
                        ...
                        <input type="text" class="form-control form-control-sm" name="documento_referencia_pago" id="documento_referencia_pago" disabled required>
                    </div>
