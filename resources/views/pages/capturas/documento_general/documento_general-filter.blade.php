                ...
                <form id="documentoFilterForm" class="needs-validation" style="margin-top: 10px;" novalidate>
                    <div class="row">
                        ...
                        <div class="form-group col-6 col-md-4 col-sm-4">
                            ...
                            <input name="fecha_manual_documento" id="fecha_manual_documento" class="form-control form-control-sm" onkeypress="changeFecha(event)" type="datetime-local" required>
