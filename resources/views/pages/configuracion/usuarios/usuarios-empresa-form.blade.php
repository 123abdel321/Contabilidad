            ...
            <div class="modal-body">
                <form id="usuariosEmpresaForm" autocomplete="off" style="margin-top: 10px;">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12 ">
                            <label for="id_empresa_rol_create">Rol<span style="color: red">*</span></label>
                            <select name="id_empresa_rol_create" id="id_empresa_rol_create" class="form-control form-control-sm" style="width: 100%; font-size: 13px;" required>
