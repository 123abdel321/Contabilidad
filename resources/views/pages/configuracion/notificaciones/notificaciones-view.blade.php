            ...
            <div class="card-body row">
                ...
                <div class="tab-content" style="background-color: white; border-top-right-radius: 10px;">
                    <div class="tab-pane fade" id="whatsapp" role="tabpanel" aria-labelledby="whatsapp_tab">
                        @include('pages.configuracion.notificaciones.notificaciones_whatsapp-table')
                    </div>
                    <div class="tab-pane fade show active" id="email" role="tabpanel" aria-labelledby="email_tab">
                        @include('pages.configuracion.notificaciones.notificaciones_email-table')
                    </div>
                </div>
...
@include('pages.configuracion.notificaciones.notificaciones_email-detalle')
@include('pages.configuracion.notificaciones.notificaciones_whatsapp-detalle')
