										...
										<tbody>
											@if($debitoTotal || $creditoTotal)
												<tr>
													...
													<td class="valor padding5">{{ $debitoTotal }}</td>
												</tr>
											@endif
											@if($creditoTotal || $debitoTotal)
												<tr>
													<td class="padding5" style="font-weight: bold;">Credito</td>
													<td class="valor padding5">{{ $creditoTotal }}</td>
												</tr>
											@endif
										</tbody>
									</table>
		...
		<table class="tabla-detalle-factura">
			...
			<tbody class="detalle-factura">
				@foreach ($documentos as $documento)
					<tr>
						<td class="padding5 detalle-factura-descripcion">{{ $documento->cuenta->cuenta }} - {{ $documento->cuenta->nombre }}</td>
						<td class="padding5 detalle-factura-descripcion">
							@if ($documento->nit) 
								{{ $documento->nit->numero_documento }} - {{ $documento->nit->nombre_nit ?? $documento->nit->razon_social }}
							@endif
						</td>
